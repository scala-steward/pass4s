...
lazy val securityDependencyOverrides = Seq(
  "io.netty" % "netty-handler" % "4.2.18.Final", // SNYK-JAVA-IONETTY-5725787 introduced through software.amazon.awssdk:s3
  "io.netty" % "netty-codec-http2" % "4.2.18.Final" // SNYK-JAVA-IONETTY-5953332 introduced through software.amazon.awssdk:s3
)
